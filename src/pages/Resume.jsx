            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="flex justify-center mb-12 section-animate opacity-0">
                    <a
                        ...
                        className="flex items-center gap-2 px-6 py-3 bg-accent text-white rounded-base hover:bg-accent-hover transition-colors duration-(--duration-medium)"
                    >
                        <FileText size={20} />
                    ...
                    <a
                        href="/JWF_resume.pdf"
                        download
                        className="flex items-center gap-2 px-6 py-3 ml-4 border border-accent text-accent rounded-base hover:bg-accent/10 transition-colors duration-(--duration-medium)"
                    >
                        <Download size={20} />
                ...
                <div className="grid grid-cols-1 gap-8">
                    {/* Education Section */}
                    <div className="bg-surface-light rounded-base overflow-hidden shadow-soft p-6 section-animate opacity-0">
                        ...
                        <div className="space-y-6">
                            <div className="border-l-2 border-accent pl-4 py-2">
                                ...
                                <p className="text-muted mb-2">University Of North Carolina at Charlotte</p>
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {["Python", "Java", "JavaScript", "SQL", "C/C#/C++", "Assembly", "HTML", "XML", "Swift"].map((skill) => (
                                        <span key={skill} className="px-3 py-1 text-sm rounded-full bg-accent/10 text-accent">
                                            {skill}
                                        </span>
                                    ))}
                                </div>
